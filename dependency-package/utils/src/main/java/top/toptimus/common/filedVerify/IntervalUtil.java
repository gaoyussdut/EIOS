package top.toptimus.common.filedVerify;
...
public class IntervalUtil {
    ...
    private static Logger logger = LoggerFactory.getLogger(IntervalUtil.class);
    ...
    private String getFormulaByAllInterval(String date_value, String interval, String connector) {
        ...
        for (String limit : interval.split("U")) {//如：（125%,135%）U (70%,80%)
            buff.append("(")
                    .append(getFormulaByInterval(date_value, limit, " && "))
                    .append(")")
                    .append(connector);
        }
...
//        // 小数点超过15位会判断异常
//        System.out.println(a.isInTheInterval("-9.999999999999999", "(-10,6)"));
//
//        System.out.println(a.isInTheInterval("0", "[-∞,0)U(0,∞]"));
//
//        Double test01 = 11.111111111111121;
//        System.out.println(getNumberDecimalDigits(test01));


        String value = "123456789.987654321";
