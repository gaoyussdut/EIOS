...
public final class URLocation {
    ...
    public void setEncoding(String _enc) {
        encoding = _enc;
    }

    public boolean hasScheme() {
        return (fields & URL_SCHEME) == URL_SCHEME;
    }

    public boolean hasServer() {
        return (fields & URL_SERVER) == URL_SERVER;
    }

    public boolean hasUserInfo() {
        return (fields & URL_USERINFO) == URL_USERINFO;
    }

    public boolean hasPort() {
        return (fields & URL_PORT) == URL_PORT;
    }

    public boolean hasPath() {
        return (fields & URL_PATH) == URL_PATH;
    }

    public boolean hasQuery() {
        return (fields & URL_QUERY) == URL_QUERY;
    }

    public boolean hasFragment() {
        return (fields & URL_FRAGMENT) == URL_FRAGMENT;
    }
    ...
    public String getPath() {
        return unescape(path, encoding);
    }

    public String getQuery() {
        return unescape(query, encoding);
    }

    public String getFragment() {
        return unescape(fragment, encoding);
    }
