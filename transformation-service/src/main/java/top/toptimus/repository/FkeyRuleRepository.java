...
public class FkeyRuleRepository {
     ...
     * @return
     */
    public List<FkeyRuleDTO> findById(String ruleId) {
        String sql = "SELECT rule_id,key,caption,fkey_type,formula,analytical_formula,params_ " +
                "from t_transformation_key_rule_definition WHERE rule_id = '" + ruleId + "'";
